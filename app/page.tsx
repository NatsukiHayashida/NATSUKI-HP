      ...
      <section className="border-t">
        <div className="container max-w-5xl py-10 md:py-14 relative overflow-hidden">
          {/*
            ...
            「AIを手段として、領域をつなぎ直して生み出す」という立ち位置の宣言へ。

            **見出しが復活している。** 前回「欲しい道具は、自分で作る。」を標語めいて
            見えると外した経緯はあるが、今回の「より良くするために、AIを学び、使い、確かめる。」
            は本人が書いて添削でも残すと決めたもの。CCの判断で外さないこと。

            **段組みは Hero と同じ「文章が左・図が右」のまま。** 本文が旧版の約3倍に
            なったため、左右の高さバランスは表示確認で見ること。

            図は H-24 の球面ネットワーク（2026-08-12 受領・2版目）。
            新文言の核「異なる領域の知識をつなぎ直し、その接続から生み出す」と
            噛み合うため、文言差し替え後もそのまま使う（本人確認済み・2026-08-13）。
          ...
          */}
          ...
          <div className="relative z-10">
              ...
              <h2 className="text-xl md:text-2xl font-bold tracking-tight leading-snug max-w-lg">
                より良くするために、
                <br />
                AIを学び、使い、確かめる。
              </h2>
              <p className="mt-4 text-sm md:text-[15px] text-muted-foreground leading-relaxed max-w-lg">
              ...
              <p className="mt-3 text-sm md:text-[15px] text-muted-foreground leading-relaxed max-w-lg">
